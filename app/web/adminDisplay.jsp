        ...
        <div class="container">
                ...
                <div class="navbar navbar-default">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="adminDisplay.jsp">Home</a></li>
                            <li>
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Bootstrap <span class="caret"></span></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="adminDisplayUpload.jsp">Upload Data</a></li>
                                    <li><a href="adminDisplayUpdate.jsp">Update Data</a></li> 
                                </ul>
                            </li>
            ...
            <div class="universalform">
                ...
                <h3><span style="font-family: Aharoni; color: #1F497D; font-weight: bold">
                        <font size="5">Upload Data</font></span></h3>
                ...
                <p><form action="FileUpload.do" method="post" enctype="multipart/form-data">
